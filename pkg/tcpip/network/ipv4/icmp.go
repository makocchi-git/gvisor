...
// ReturnError implements stack.TransportProtocol.ReturnError.  It takes a
// protocol independent error and will send the appropriate ICMPv4 message to
// the sender of the packet supplied in pkt.
...
func SendICMPError(r *stack.Route, eType header.ICMPv4Type, eCode header.ICMPv4Code, aux int, pkt *stack.PacketBuffer) bool {
	...
	// RFC 1918 also specifically ban responding to non initial fragments.
